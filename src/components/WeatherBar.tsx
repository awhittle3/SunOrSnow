...
export class WeatherBar extends React.Component<WeatherBarProps, WeatherBarState> {
    ...
    render() {
        return <div className="container">
            <div className="row">
                <div className="col-xs-2" key={-1}><WeatherDay day="Today" temperature={this.state.currentState.temperature} condition={this.state.currentState.condition} emphasize={true}/></div>
                {this.makeRow()}
            </div>
        </div>;
    }
